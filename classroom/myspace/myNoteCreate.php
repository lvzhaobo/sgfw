	  ...
	  <div class="main index" style="padding-top:32px;min-width:960px;margin:0 auto;font-size:14px;min-height:400px;">
		...
		<div class="content" style="width:800px;float:left;margin:0 0 40px 0px;padding:20px 10px;min-height:320px;">
		  ...
		  <div style="margin:20px;">
			    <form action="../../lib/request.php?action=saveNote" method="post" id="discuss">
		  ...
		  ?>
		    <div style="height:28px;border-bottom:1px solid #00AAFF;padding:6px 20px;color:#333333;line-height:28px;color:#333333;">
			  <div style="width:200px;float:left;overflow:hidden;"><?php echo mb_substr($file_real_name,0,28);?></div><div style="width:280px;float:left;overflow:hidden;"><?php echo mb_substr($homework["comment"],0,28);?></div><div style="width:200px;float:left;"><?php echo $homework["create_time"]?></div><div style="float:left;"><a href="viewfile.php?id=<?php echo $homework['id']?>">查看</a></div>
			</div>
		  <?php //}
		  }}
		  else{
