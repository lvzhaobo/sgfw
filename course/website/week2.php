<html>
  ...
  <body style="margin:0px;font-family:'Microsoft YaHei',宋体,Arial;">
	<div style="padding:20px 0px;line-height:24px;border-bottom:1px dashed #FF9900;margin:0 20px;font-size:14px;">
	  ...
	  <div style="line-height:24px;padding:20px 0;border-bottom:1px dashed #FF9900;margin:0px 20px;font-size:15px;">
...
其实每一小部分在第一周任务中基本都已经做过了。复杂的网站也是通过基础知识堆积起来的。先分清层次有助于看清本质。</p>
		  ...
		  <div style="line-height:24px;padding:20px 0;margin:0 20px;border-bottom:1px dashed #FF9900;font-size:15px;">
		    <div style="font-size:18px;font-weight:bold;color:#333333;margin:10px 0;">
			作业及要求
			</div>
			<div style="">
			  <ul style="font-size:14px;">
			    <li>1.游戏网站，英雄联盟、疯狂的小鸟或消消乐等等游戏的介绍、玩法</li>
		  ...
		  <div style="line-height:24px;padding:20px 0;margin:0 20px;font-size:14px;">
		    <div style="font-size:18px;font-weight:bold;color:#333333;margin:10px 0;">
			  技巧
			</div>
			<div style="">
