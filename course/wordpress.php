			...
			<div id="week1" name="week1" class="index_feature_box al_left" style="margin:28px 10px;min-height:200px;line-height:28px;">
			  <div>
			    <div style="float:left;height:120px;overflow:hidden;">
				  <img src="../src/images/wordpress.jpg" style="width:200px;"/>
				</div>
				<div style="float:left;padding:0px 20px;line-height:22px;font-size:12px;">
				  ...
				  <div><span style="color:#999999;margin:0 10px 0 0;">团队要求</span><span>1-2人组成小组</span></div>
				  <div><span style="color:#999999;margin:0 10px 0 0;">课程目标</span><span>1.社团/班级网站；2.个人博客；3.小企业网站</span></div>
				  <div><span style="color:#999999;margin:0 10px 0 0;">关联课程</span><span>1.HTML、CSS；2.Javascript</span></div>
				  ...
				  <a href="../lib/selectCourse.php?course=wordpress">
				    <div style="margin:5px 0 5px 10px;background-color:#FFFFFF;font-size:20px;font-weight:bold;text-align:center;padding:14px 0;color:#0099FF;border:2px solid #FF9900;">
				      <span>
					  <?php if(empty($username) || !isset($row["project"]) || $row["project"]!="wordpress"){?>
					  学习此课程
					  <?php }
					  else{?>
					  已选择
				  ...
				  <div style="color:#333333;">
				    ...
				    <div style="padding:0 10px;">
					  <div style="font-weight:bold;margin:10px 0;">
					    <span style="font-size:14px;color:#0099FF;margin:0 22px 0 0;">Wordpress建设网站</span>
					  </div>
					...
					<div style="padding:10px;">
					  <div style="font-weight:bold;margin:10px 0;">
					    <span style="font-size:14px;color:#FF9900;margin:0 22px 0 0;">其他部分</span>
					  </div>
