			...
			<div id="week1" name="week1" class="index_feature_box al_left" style="margin:28px 10px;min-height:200px;line-height:28px;">
			  <div>
			    <div style="float:left;height:120px;overflow:hidden;">
				  <img src="../src/images/acm.jpg" style="width:200px;"/>
				</div>
				<div style="float:left;padding:0px 20px;line-height:22px;font-size:12px;">
				  <div><span style="color:#999999;margin:0 10px 0 0;">课程时长</span><span>共6周</span></div>
				  <div><span style="color:#999999;margin:0 10px 0 0;">团队要求</span><span>1-3人组成小组</span></div>
				  <div><span style="color:#999999;margin:0 10px 0 0;">课程目标</span><span>1.了解ACM；2.利用基本知识解答题目；3.学习数据结构和算法</span></div>
				  <div><span style="color:#999999;margin:0 10px 0 0;">关联课程</span><span>1.数据结构；2.算法</span></div>
				  <div><span style="color:#999999;margin:0 10px 0 0;">建议</span><span>了解过C、C++、Java等语言的同学</span></div>
				</div>
				  <?php 
					include '../lib/db.php';
