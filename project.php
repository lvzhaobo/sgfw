<html>
  <head>
    ...
    <style type="text/css">
	  ...
	  .project_item {width:206px;height:188px;margin:5px 0px 0px 10px;float:left;padding:10px;border:2px solid #E2E2E2;color:#000000;}
	  .project_item_title {margin:20px 0 0 20px;font-size:16px;font-weight:bold;color:#FF6600;}
	  ...
	  <div class="main_index" style="width:960px;margin:0 auto;font-size:14px;">
			...
			<div style="width:100%;margin:40px 0 0 0;min-height:480px;">
			  ...
			  <div class="project_item" onmouseover="this.style.border='2px solid #0099FF';" onmouseout="this.style.border='2px solid #E2E2E2';">
				...
				<span style="font-size:12px;">技术：HTML、PHP、MySQL、JQuery、GitHub</span>
			  ...
			  <div class="project_item" onmouseover="this.style.border='2px solid #0099FF';" onmouseout="this.style.border='2px solid #E2E2E2';">
				...
				<div style="margin-top:5px;">开发者：<span style="font-weight:bold;">梦想科技</span>&nbsp;&nbsp;
				<br /><span style="font-size:12px;">DS-0001</span>&nbsp;<span style="color:#0099FF;">第一周</span>&nbsp;&nbsp;<span title="喜欢：28" style="margin-left:10px;font-size:20px;color:#FF0000;">28</span></div>
				<span style="font-size:12px;">技术：HTML、PHP、MySQL、JQuery、GitHub</span>
			  ...
			  <div class="project_item" onmouseover="this.style.border='2px solid #0099FF';" onmouseout="this.style.border='2px solid #E2E2E2';">
				...
				<div style="margin-top:5px;">开发者：<span style="font-weight:bold;">梦想科技</span>&nbsp;&nbsp;
				<br /><span style="font-size:12px;">DS-0001</span>&nbsp;<span style="color:#0099FF;">第一周</span>&nbsp;&nbsp;<span title="喜欢：12" style="margin-left:10px;font-size:20px;color:#FF0000;">12</span></div>
				<span style="font-size:12px;">技术：HTML、PHP、MySQL、JQuery、GitHub</span>
			  ...
			  <div class="project_item" onmouseover="this.style.border='2px solid #0099FF';" onmouseout="this.style.border='2px solid #E2E2E2';">
				...
				<div style="margin-top:5px;">开发者：<span style="font-weight:bold;">梦想科技</span>&nbsp;&nbsp;
				<br /><span style="font-size:12px;">DS-0001</span>&nbsp;<span style="color:#0099FF;">第一周</span>&nbsp;&nbsp;<span title="喜欢：8" style="margin-left:10px;font-size:20px;color:#FF0000;">8</span></div>
				<span style="font-size:12px;">技术：HTML、CSS</span>
