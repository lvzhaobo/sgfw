...
$index = <<<EOF
    <div style="width:200px;height:100%;z-index:0;float:left;position:fixed;font-weight:bold;font-size:16px;background-color:#FFFFFF;padding:10px 0;margin:-30px 0 0 0;line-height:48px;border-right:0px solid #F3F3F3;box-shadow:0px 1px 5px #CCCCCC;">
		...
		<div style="text-align:center;font-weight:normal;font-size:14px;">
		  <a href="index.php">
		  <div style="color:#737373;border-top:1px solid #EEEEEE;font-weight:normal;">
		    <span>基本信息</span>
		  </div>
		  </a>
		  <a href="myStudy.php">
		  <div style="color:#737373;border-top:1px solid #EEEEEE;font-weight:normal;border-left:4px solid #FFAA00;color:#FFAA00;background-color:#EEEEEE;font-weight:bold;">
		    <span>我的课程</span>
		  </div>
		  </a>
		  ...
		  <div style="color:#737373;border-top:1px solid #EEEEEE;border-bottom:1px solid #EEEEEE;font-weight:normal;">
		    <span>学习资源</span>
		  </div>
		  </a>
		</div>
