<html>
  <head>
    ...
    <style type="text/css">
	  ...
	  .project_item {width:206px;height:200px;margin:20px 0px 0px 20px;float:left;color:#FF6600;border:2px solid #F3F3F3;box-shadow:#DCDCDC;}
	  .project_item:hover {border:2px solid #FF9900;}
	  .project_item_title {margin:5px 0;font-size:14px;font-weight:weight;color:#333333;text-align:center;}
	  .project_item hr {color:#FFFFFF;height:1px;display:none;}
	  .text {margin:5px;font-size:12px;color:#333333;font-weight:normal;}
	</style>
	  ...
	  <div class="main_index" style="width:960px;margin:0 auto;font-size:14px;">
	    <div style="width:100%;margin:40px 0 40px 0;min-height:600px;">
			  <div style="margin:0 0 0 0px;height:48px;border-bottom:2px solid #F3F3F3;">
				...
				<div style="float:right;width:334px;height:40px;">
				  <a href="register.php">
			  ...
			  <?php 
			      $data = array(
								...
								array("name"=>"软件测试","url"=>"","img"=>"","text"=>"多方面、多角度掌握软件测试，你掌握的不仅是书本上的知识。"),
								...
								array("name"=>"第三方开发","url"=>"","img"=>"","text"=>"百度、Google等公司有开发者平台，开发者可以在这些平台上方便快捷的开发、部署应用。"),
								array("name"=>"等你来发掘","url"=>"","img"=>"","text"=>"如果你有好的想法，能够帮助自己或别人请联系我们。"),
				  );
			  ?>
